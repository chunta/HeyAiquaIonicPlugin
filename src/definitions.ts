...
export interface HeyAiquaIonicPluginPlugin {
  ...
  setFirstName(options: { firstname: string }): Promise<void>;
  setLastName(options: { lastname: string }): Promise<void>;
  setCity(options: { city: string }): Promise<void>;
  setEmail(options: { email: string }): Promise<void>;
  setPhoneNumber(options: { phoneNo: string }): Promise<void>;
  setDayOfBirth(options: { day: number }): Promise<void>;
  ...
  logRecommendationClickedWithScenarioId(options: { scenarioId: string, modelId: number, productId: string, recommendationId: string;}): Promise<unknown>;
}
